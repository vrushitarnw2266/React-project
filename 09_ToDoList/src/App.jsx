  ...
  return (
    ...
    <h1 className='font-bold text-center text-xl'> !Task Manage Your Todos At One Place</h1>
        <div className="addTodo">
          ...
          <button onClick={handleAdd} disabled={todo.length===0} className='bg-violet-800 hover:bg-violet-950 p-2 py-1 text-white rounded-md mx-6' >Add</button>
        </div>
        ...
        <div className="todos">
          ...
          return (showFinished || !item.isCompleted) &&  <div key={item.id} className="todo flex w-1/4 my-3 justify-between" >
            ...
            <div className="buttons flex h-full">
              <button onClick={(e=>{handleEdit(e,item.id)})}className='bg-violet-800 hover:bg-violet-950 p-2 py-1 text-white rounded-md mx-1'>Edit</button>
